...
import com.milk.interceptor.JwtTokenAdminInterceptor;
import com.milk.interceptor.JwtTokenUserInterceptor;
import com.milk.json.JacksonObjectMapper;
...
public class WebMvcConfiguration extends WebMvcConfigurationSupport {
    ...
    protected void addInterceptors(InterceptorRegistry registry) {
        ...
        registry.addInterceptor(jwtTokenUserInterceptor)
                ...
                .excludePathPatterns("/user/evaluation/**");
    }
